...
export default function QuotationDetail() {
  ...
  if (loading) return <div className="container mt-5">Loading quotation details...</div>;
  ...
  return (
    <div className="container">
      <div className="mb-4">
        <button className="btn btn-link px-0 text-decoration-none" onClick={() => router.push('/quotations')}>
            ...
            <div className="col-md-3 text-end">
              <div className="d-flex flex-column gap-2">
                ...
                <div className="d-flex gap-2">
                  <button className="btn btn-outline-secondary btn-sm w-50" onClick={() => router.push(`/quotations/${quote._id}/edit`)}>Edit</button>
                  <button className="btn btn-outline-secondary btn-sm w-50" onClick={() => router.push(`/quotations/${quote._id}/preview`)}>
                    Preview PDF
                  </button>
                </div>
              </div>
      ...
      <div className="card shadow-sm border-0 mb-5">
        <div className="card-body">
          ...
          {activeTab === 'Negotiation' && (
            <div>
              <h5 className="mb-3">Customer Negotiation & Counteroffers</h5>
              <div className="text-center py-5 text-muted">
                <i className="fa fa-comments fs-2 mb-3"></i>
                <p>No customer counteroffers received yet.</p>
              </div>
            </div>
          )}
