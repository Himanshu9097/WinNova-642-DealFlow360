...
export default function QuotationsList() {
  ...
  if (loading) return <div className="container mt-5">Loading quotations...</div>;
    ...
    <div className="container">
      <div className="row mb-4 align-items-center">
        ...
        <div className="col-md-4 text-end">
          <Link href="/quotations/create" className="btn btn-primary fw-bold px-4 py-2" style={{backgroundColor: '#D6536D', borderColor: '#D6536D'}}>
            + Create Quotation
          </Link>
        </div>
      </div>
                ...
                {quotations.length === 0 ? (
                  ...
                  quotations.map(quote => (
                    <tr key={quote._id}>
                      ...
                      <td>
                        <Link href={`/quotations/${quote._id}`} className="btn btn-sm btn-outline-primary">
                          View
                        </Link>
                      </td>
                    </tr>
